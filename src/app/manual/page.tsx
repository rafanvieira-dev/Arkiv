...
export default function ManualPage() {
  return (
    <div className="container mx-auto py-2">
      <PageHeader title="Manual do Sistema ARKIV" description="Um guia completo para todas as funcionalidades e regras de negócio do sistema." />
      <Card>
        <CardContent className="p-0">
          <ScrollArea className="h-[calc(100vh-200px)]">
            <pre className="text-sm whitespace-pre-wrap p-6 font-sans">
              {manualContent}
            </pre>
          </ScrollArea>
        </CardContent>
